        ...
        <div className='max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md'>
            ...
            <div className='bg-gray-50 p-6 rounded-md'> 
                ...
                <div className='space-x-2 space-y-2'>
                    ...
                    <button className='bg-red-100 text-red-600 px-4 py-2 rounded-md border-1 cursor-pointer' onClick={handelRemoveCourse}>Remove Course</button>
                </div>
                <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
                    <div>
                        <label htmlFor="title" className='block text-sm font-medium text-gray-700 mb-1'>Title</label>
                        <input id='title' type="text" placeholder='Course Title' className='w-full border px-4 py-2 rounded-md' onChange={(e)=>setTitle(e.target.value)} value={title}/>
                    </div>

                     <div>
                        <label htmlFor="subtitle" className='block text-sm font-medium text-gray-700 mb-1'>SubTitle</label>
                        <input id='subtitle' type="text" placeholder='Course SubTitle' className='w-full border px-4 py-2 rounded-md' onChange={(e)=>setSubTitle(e.target.value)} value={subTitle}/>
                    </div>

                     <div>
                        <label htmlFor="description" className='block text-sm font-medium text-gray-700 mb-1'>Description</label>
                        <textarea id='description' placeholder='Course Description' className='w-full border px-4 py-2 rounded-md h-24 resize-none' onChange={(e)=>setDescription(e.target.value)} value={description}/>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" id="thumbnail" hidden ref={thumb} accept='image/*' onChange={handleThumbnail}/>
                    </div>
                    <div className='relative w-[300px] h-[170px]'>
                        <img src={frontendImage} alt='' className='w-[100%] h-[100%] border-black rounded-[5px] cursor-pointer' onClick={()=>thumb.current.click()}/>

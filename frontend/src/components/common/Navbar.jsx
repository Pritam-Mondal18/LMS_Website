...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 bg-[#090040] transition-all duration-300 ${scrolled ? 'py-3 shadow-xl shadow-black/40 border-b border-brand-purple/20' : 'py-4 border-b border-brand-purple/10'}`}>
